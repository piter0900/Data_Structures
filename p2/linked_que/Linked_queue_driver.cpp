/****************************************************
 * Executable:  Linked_queue_driver
 * Author:  Douglas Wilhelm Harder
 * Copyright (c) 2006-14 by Douglas Wilhelm Harder.  All rights reserved.
 *
 * DO NOT EDIT THIS FILE
 *
 * Create an instance of the Linked_queue_tester<int>
 * or Linked_queue_tester<double> classes and call
...
int main( int argc, char *argv[] ) {
	...
	if ( argc == 1 || !std::strcmp( argv[1], "int" ) ) {
		...
		Linked_queue_tester<int> tester;

		tester.run();
	} else if ( !std::strcmp( argv[1], "double" ) ) {
		Linked_queue_tester<double> tester;
